...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<div class="bo_all">
		<div class="bo_g">
			<div class="swiper-container1" style="overflow:hidden; position:relative;">
				<div class="swiper-wrapper">
					...
					<?php
						...
						while($rowb = sql_fetch_array($rsb)){
						 ...
						 ?>
						<div class="swiper-slide"><img src="<? echo G5_URL; ?>/data/file/<?=$bo_table.'/'.$tfarray_file?>" border=0  alt="<?=$trow['wr_subject']?>" ></div>
						<?}
						}							
							unset($tfarray);
						?>
				...
				<div class="swiper-pagination1" style="z-index:99;position:absolute; bottom:10px; left:0px; text-align:center; ;"></div>
		...
		<div class="bo_t">
			...
			<br>
				 ...
				 <a href="<?php echo $list_href ?>" class="btn_b01 btn"><i class="fa fa-list" aria-hidden="true"></i> 목록으로</a>
  ...
  <?php if ($prev_href || $next_href) { ?>
	<ul class="bo_v_nb">
		<?php if ($prev_href) { ?><li class="btn_prv" style="width:50%; float:left;"><span class="nb_tit"><i class="fa fa-caret-up" aria-hidden="true"></i> PREVIOUS</span><a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a> <span class="nb_date" style="display:none;"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span></li><?php }else{ ?>
		<li class="btn_prv" style="width:50%; float:left;" ><span class="nb_tit"><i class="fa fa-caret-up" aria-hidden="true"></i> PREVIOUS</span><a href="#none">이전상품이 없습니다.</a> <span class="nb_date" style="display:none;"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span></li>
		<?}?>
		<?php if ($next_href) { ?><li class="btn_next" style="border-left:0px;width:50%; float:left;"><span class="nb_tit"><i class="fa fa-caret-down" aria-hidden="true"></i> NEXT</span><a href="<?php echo $next_href ?>"><?php echo $next_wr_subject;?></a>  <span class="nb_date" style="display:none;"><?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span></li><?php }else{ ?>
		<li class="btn_next" style="border-left:0px;width:50%; float:left;"><span class="nb_tit"><i class="fa fa-caret-down" aria-hidden="true"></i> NEXT</span><a href="#none">다음상품이 없습니다.</a>  <span class="nb_date" style="display:none;"><?php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span></li>
		<?}?>
	</ul>
	<?php } ?>
    ...
    <section id="bo_v_atc">
		...
		<div style="border-bottom:1px solid #333; margin:40px auto; font-size:2em;">Detail view</div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_left">
            ...
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fas fa-times"></i> 삭제</a></li><?php } ?>
