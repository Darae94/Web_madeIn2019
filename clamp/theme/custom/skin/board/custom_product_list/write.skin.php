...
<section id="bo_w">
    ...
    <?php } ?>
	 ...
	 <div>항목명과 내용은 " : " 콜론 으로 구분합니다. 내용에 구분자(" : " 콜론)를 넣으면 안됩니다.</div>
	 <?php for($i=1; $i<=7; $i++){ //  wr_10 은 브랜드로 씀 8,9는 안씀?>
	
	  <div class="write_div">      
        <label for="wr_<?=$i?>" class="sound_only">추가항목설정</label>
        <input type="text" name="wr_<?=$i?>" value="<?php echo ${"wr_".$i}?>" id="wr_<?=$i?>" class="frm_input full_input" size="50" placeholder="항목명:내용">
    </div>
	 <?}?>
