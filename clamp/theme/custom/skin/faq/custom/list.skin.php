...
<div class="select_bo_cate mview">
	<a class="sel" rel="선택"><? if($fm['fm_subject']) echo $fm['fm_subject']; else echo "카테고리 선택"; ?></a>
	<ul style="display:none;">
		 <li><a href="#none" <?php echo $category_option;?> >선택</a></li>
		 <?php
...
<fieldset id="faq_sch">
    ...
    <input type="text" name="stx" value="<?php echo $stx;?>" required id="stx" class="frm_input " size="15" maxlength="15" placeholder="FAQ 검색">
