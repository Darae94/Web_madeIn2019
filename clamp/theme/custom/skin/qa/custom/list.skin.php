...
<div id="bo_list">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fas fa-pencil-alt"></i> 문의등록</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
    <!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col">번호</th>
            <th scope="col">제목</th>
            <th scope="col" class="snone">글쓴이</th>
            <th scope="col" class="snone">등록일</th>
            <th scope="col" class="snone">상태</th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr>
            ...
            <td class="td_subject">
				...
				<div class="mview">
					...
					<div class="gall_info">
						<span class=" <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 답변완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 답변대기'); ?></span>   
            ...
            <td class="td_name snone"><?php echo $list[$i]['name']; ?></td>
            <td class="td_date snone"><?php echo $list[$i]['date']; ?></td>
            <td class="td_stat snone"><span class=" <?php echo ($list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($list[$i]['qa_status'] ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 답변완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 답변대기'); ?></span></td>
        </tr>
        <?php
        }
        ?>
